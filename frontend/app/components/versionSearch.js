...
const VersionSearch = ({label},ref) =>{
   ...
   // let counter = 1;
    ...
    return(
        <div className={styles.comboBoxContainer}> <Autocomplete options={versions} disablePortal renderInput={(params) => <TextField {...params} className="combobox" label={label} placeholder={label} ref={ref} />} /> </div>
